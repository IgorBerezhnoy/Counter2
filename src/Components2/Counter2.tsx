        ...
        <div className={s.wrapper}>
            <div className={s.settings}>
                <div className={s.deskSettings}>
                    <SuperInput title={'max value'} startNum={maxNumForSetting} setStartNum={setMaxNumForSetting}  error={errorOnOf}/>
                    <SuperInput title={'start value'} startNum={minNumForSetting} setStartNum={setMinNumForSetting} error={errorOnOf} />
